<div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md !w-full min-h-[90vh]">
    <div class="flex justify-between mb-4 border-b pb-6">
        <div class="font-medium font-mona-reg">Edit Product</div>
    </div>
    <form class="btnsubmit" data-aksi="submitproductedit">
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-4">
            <div class="lg:h-[75vh] h-full overflow-y-auto">
                ...
                <div class="mt-3">
                    ...
                    <span class="text-sm font-bold text-gray-500 uppercase OldStock">Old Stock : 50</span><br>
